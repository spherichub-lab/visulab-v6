/**
 * SupabaseTratamentosService - Service implementation for tratamentos using Supabase MCP
 * Provides CRUD operations for tratamentos with RLS enforcement
 */
...
export class SupabaseTratamentosService {
...
export const supabaseTratamentosService = new SupabaseTratamentosService();
